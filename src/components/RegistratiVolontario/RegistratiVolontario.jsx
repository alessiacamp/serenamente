...
import { FaUserAlt, FaCamera, FaRegEdit } from "react-icons/fa";
    ...
    <div className="d-flex justify-content-center align-items-center min-vh-100 bg-white">
      ...
      >
        ...
        <div className='position-relative mb-4'>
          <textarea
            name="messaggio"
            placeholder='Perché vuoi diventare volontario?'
            required
            className="w-100 ps-5 py-2"
            style={{
              color: '#603311',
        ...
        >
          {registrationSuccess ? 'Registrazione completata!' :
            (isSubmitting ? 'Registrazione in corso...' : 'Registrati come Volontario')}
        </button>
      </form>
    </div>
  );
